...
if showpoints
    ...
    hPoints = line(nan, nan, ...
        ...
        'Color', [1 1 0], ...
        'Marker', 'o', ...
        'MarkerFaceColor', [1 0.3 0], ...
        'MarkerEdgeColor', [1 0.3 0], ...
...
%--------------------------------------------------------------------------
    function updatePoints(clickType)
        ...
        if length(x) == N
            %plot(hFig, [selectedPoints(1, 1), selectedPoints(end, 1)], [selectedPoints(1, 2), selectedPoints(end, 2)], 'Color', 'y', 'LineWidth', 2);
            set(hPoints, ...
                'XData', storedPoints(1,1), ...
                'YData', storedPoints(1,2));
            exitFcn();
            print(storedPoints);
        end
    end
